            ...
            <div class="footer-widget-area padding-five-tb sm-padding-30px-tb">
                <div class="container">
                    <div class="row row-cols-1 row-cols-lg-4 row-cols-sm-2">
                        <div class="col widget border-right border-color-medium-dark-gray md-no-border-right md-margin-30px-bottom text-center text-sm-start">
                            <!-- start logo -->
                        ...
                        <div class="col widget border-right border-color-medium-dark-gray padding-45px-left md-padding-15px-left md-no-border-right md-margin-30px-bottom text-center text-sm-start">
                        ...
                        <div class="col widget border-right border-color-medium-dark-gray padding-45px-left md-padding-15px-left md-no-border-right xs-margin-30px-bottom text-center text-sm-start">
                            ...
                            <div class="text-small">Email: <a href="mailto:hello@tribre.com">hello@tribre.com</a></div>
                        ...
                        <!-- start instagram -->
                        <div class="col widget padding-45px-left md-padding-15px-left text-center text-sm-start">
            ...
            <div class="bg-dark-footer padding-50px-tb text-center sm-padding-30px-tb">
                <div class="container">
                    <div class="row row-cols-1 row-cols-md-2">
                        <!-- start copyright -->
                        <div class="col text-md-start text-small text-center">&copy; 2025 Stewards of <a href="http://www.tribre.com" target="_blank" class="text-dark-gray">Tribre</a></div>
                        <div class="col text-md-end text-small text-center">
