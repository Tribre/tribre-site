...
<html class="no-js" lang="en">
    <head>
        <title>Tribre AI</title>
        <?php include 'inc-head.php';?>
    </head>
    <body>
        <!-- start header -->
        <header>
        <?php include 'inc-nav-list.php';?>
        <?php include 'inc-nav-tribre-hmb.php';?>
        </header>
        <!-- end header -->
        ...
        <section class="p-0 bg-extra-light-gray">
            <div class="container-fluid">
                <div class="row row-cols-1 row-cols-lg-2">
                    <div class="col minheight-fullscreen p-0 cover-background d-none d-lg-block" style="background-image:url('images/bg/mush-mesh-1920x1080.png');"></div>
                    <div class="col minheight-fullscreen d-flex align-items-center bg-black p-0">                         
                        <div class="text-center padding-three-all sm-padding-15px-all w-100">
                            <div class="margin-nine-bottom md-margin-50px-bottom sm-margin-15px-bottom"><img src="images/logo-white.png" data-at2x="images/logo-white@2x.png" alt="Pofo" /></div>
                            ...
                            <div class="bg-extra-dark-gray padding-eight-all lg-padding-five-lr border-radius-6 w-70 xl-w-75 lg-w-80 sm-w-100 mx-auto sm-padding-30px-all">
                                <h6 class="font-weight-300 text-white-2 margin-20px-bottom sm-margin-15px-bottom">Tribre AI is in closed beta.</h6>
                                <p class="text-medium w-70 xl-w-80 lg-w-90 mx-auto margin-40px-bottom sm-w-100 sm-margin-15px-bottom">Join the Tribre AI waitinglist.</p>
