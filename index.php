...
<html class="no-js" lang="en">
    <head>
        ...
        <!-- description -->
        <meta name="description" content="The different modules of Tribre. Use them separately, or expand the impact, use more, and connect with others.">
        <!-- keywords -->
        <meta name="keywords" content="tribre, solo, teams, communities, purpose, role library, ai, impact, growth">
        <!-- favicon -->
        ...
        <header class="no-sticky">
            ...
            <nav class="navbar full-width-pull-menu navbar-top-scroll no-border-top white-link nav-box-width no-transition">
                ...
                <div class="container-fluid nav-header-container h-100px sm-h-70px">
                    <!-- start logo -->
                    <div class="col-auto ps-0"><a href="index.html" title="Pofo" class="logo"><img src="images/logo-full-white.png" data-at2x="images/logo-full-white@2x.png" alt="Pofo"></a></div>
                    <!-- end logo -->
                    <!-- start main menu -->
                    <div class="col-auto pe-0">
                        <div class="menu-wrap full-screen">
                            <div class="row g-0 h-100 justify-content-center">
                                <div class="col-md-6 p-0 text-center z-index-0 d-none d-md-flex flex-column justify-content-center cover-background" style="background-image:url('images/menu-background-1.png')"> 
                                    ...
                                    <div class="position-absolute bottom-50 text-center w-100 margin-30px-bottom">
                                        <div class="text-small text-extra-medium-gray">&copy; 2025 Tribre</div>
                                    </div>
                                </div>
                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide cover-background grid-item text-start" style="background-image:url('/html/images/carousel/Tribre.png');">
                                <div class="slide-hover-box">
                                    ...
                                    <figure class="position-absolute">
                                        <figcaption>
                                            <a href="single-project-page-01.html"><h6 class="font-weight-300 text-white-2 margin-20px-bottom">Tribre</h6></a>
                            ...
                            <div class="swiper-slide cover-background grid-item text-start" style="background-image:url('/html/images/carousel/TriTe.png');">
                                <div class="slide-hover-box">
                                    ...
                                    <figure class="position-absolute">
                                        <figcaption>
                                            <a href="single-project-page-02.html"><h6 class="font-weight-300 text-white-2 margin-20px-bottom">Tribre Teams</h6></a>
                                            <p class="text-white-2 w-85 md-w-100">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                                            <div class="separator-line-horrizontal-medium-light2 opacity5 bg-white margin-35px-top md-margin-15px-top"></div>
                                        </figcaption>
                                    </figure>
                            ...
                            <div class="swiper-slide cover-background grid-item text-start" style="background-image:url('/html/images/carousel/TriSo.png');">
                                <div class="slide-hover-box">
                                    ...
                                    <figure class="position-absolute">
                                        <figcaption>
                                            <a href="single-project-page-03.html"><h6 class="font-weight-300 text-white-2 margin-20px-bottom">Tribre Solo</h6></a>
                                            <p class="text-white-2 w-85 md-w-100">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                                            <div class="separator-line-horrizontal-medium-light2 opacity5 bg-white margin-35px-top md-margin-15px-top"></div>
                                        </figcaption>
                                    </figure>
                            ...
                            <div class="swiper-slide cover-background grid-item text-start" style="background-image:url('/html/images/carousel/TriCo.png');">
                                <div class="slide-hover-box">
                                    ...
                                    <figure class="position-absolute">
                                        <figcaption>
                                            <a href="single-project-page-04.html"><h6 class="font-weight-300 text-white-2 margin-20px-bottom">Tribre Communities</h6></a>
                                            <p class="text-white-2 w-85 md-w-100">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                                            <div class="separator-line-horrizontal-medium-light2 opacity5 bg-white margin-35px-top md-margin-15px-top"></div>
                                        </figcaption>
                                    </figure>
                            ...
                            <div class="swiper-slide cover-background grid-item text-start" style="background-image:url('/html/images/carousel/bg-rl.png');">
                                <div class="slide-hover-box">
                                    ...
                                    <figure class="position-absolute">
                                        <figcaption>
                                            <a href="single-project-page-06.html"><h6 class="font-weight-300 text-white-2 margin-20px-bottom">Tribre Role Library</h6></a>
                                            <p class="text-white-2 w-85 md-w-100">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                                            <div class="separator-line-horrizontal-medium-light2 opacity5 bg-white margin-35px-top md-margin-15px-top"></div>
                                        </figcaption>
                                    </figure>
                            ...
                            <div class="swiper-slide cover-background grid-item text-start" style="background-image:url('/html/images/carousel/TriAI.png');">
                                <div class="slide-hover-box">
                                    ...
                                    <figure class="position-absolute">
                                        <figcaption>
                                            <a href="single-project-page-07.html"><h6 class="font-weight-300 text-white-2 margin-20px-bottom">Tribre AI</h6></a>
                                            <p class="text-white-2 w-85 md-w-100">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                                            <div class="separator-line-horrizontal-medium-light2 opacity5 bg-white margin-35px-top md-margin-15px-top"></div>
                                        </figcaption>
                                    </figure>
                            ...
                            <div class="swiper-slide cover-background grid-item text-start" style="background-image:url('/html/images/carousel/TriPu.png');">
                                <div class="slide-hover-box">
                                    ...
                                    <figure class="position-absolute">
                                        <figcaption>
                                            <a href="single-project-page-08.html"><h6 class="font-weight-300 text-white-2 margin-20px-bottom">Tribre Purpose</h6></a>
                                            <p class="text-white-2 w-85 md-w-100">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                                            <div class="separator-line-horrizontal-medium-light2 opacity5 bg-white margin-35px-top md-margin-15px-top"></div>
                                        </figcaption>
                                    </figure>
                            ...
                            <!-- end slide item -->
                            <!-- start slide item -- >
                            <div class="swiper-slide cover-background grid-item text-start" style="background-image:url('/html/images/carousel/bg-tribre.png');">
                                <div class="slide-hover-box">
                                    <div class="opacity-medium bg-black"></div>
                                    <figure class="position-absolute">
                                        <figcaption>
