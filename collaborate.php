...
<html class="no-js" lang="en">
    ...
    <body>
        ...
        <section class="p-0 one-third-screen position-relative wow animate__fadeIn">
            ...
            <div class="container position-relative">
                <div class="row">
                    <div class="col-12 one-third-screen page-title-large d-flex flex-column justify-content-center text-center">
                        ...
                        <!-- end sub title -->
                        <!-- start page title -->
                        <h1 class="alt-font text-white-2 font-weight-600 w-55 md-w-80 sm-w-100 mx-auto mb-0">Looking for a excellent business idea?</h1>
                        <!-- end page title -->
                    </div>
            ...
            <div class="swiper-auto-fade swiper z-index-minus2 position-absolute top-0 w-100 h-100" data-slider-options='{ "loop": true, "effect":"fade", "slidesPerView": "1", "allowTouchMove":true, "autoplay": { "delay": 5000, "disableOnInteraction": false }, "keyboard": { "enabled": true, "onlyInViewport": true }, "navigation": { "nextEl": ".swiper-button-next", "prevEl": ".swiper-button-prev" }, "pagination": { "el": ".swiper-pagination", "clickable": true } }'>
        ...
        <section class="wow animate__fadeIn big-section" id="section-down">
            <div class="container">
                <div class="row row-cols-1 row-cols-lg-2">
                    ...
                    <div class="col last-paragraph-no-margin wow animate__fadeInRight">
                        <div class="padding-ten-all bg-light-gray border-radius-6 lg-padding-seven-all md-padding-eight-all sm-padding-30px-all h-100 text-center text-md-start">
                            <img src="https://via.placeholder.com/1000x700" alt="" class="border-radius-6 margin-35px-bottom sm-margin-30px-bottom">
                            ...
                            <a href="about-us-modern.html" class="btn btn-dark-gray btn-small text-extra-small border-radius-4 margin-25px-top">About Company</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row row-cols-1 row-cols-lg-3 justify-content-center g-0">
                    ...
                    <div class="col image-hover-style-3 last-paragraph-no-margin bg-light-gray">
                        <div class="feature-box-wrap">
                            ...
                            <div class="w-100 small-screen lg-h-350px sm-h-300px d-table arrow-top">
                    ...
                    <div class="col image-hover-style-3 last-paragraph-no-margin bg-light-gray">
                        <div class="feature-box-wrap md-swap-block">
                            <div class="w-100 small-screen lg-h-350px sm-h-300px d-table arrow-bottom">
                                <div class="d-table-cell align-middle padding-eighteen-lr lg-padding-twelve-lr text-center md-padding-ten-lr sm-padding-seven-all">
        ...
        <section class="wow animate__fadeIn">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-xl-7 col-lg-6 col-md-10 col-sm-8 text-center">
                        <h6 class="alt-font text-extra-dark-gray text-uppercase font-weight-500 w-80 mx-auto margin-35px-bottom lg-w-100 wow animate__fadeInUp">We would love to hear about start your new project?</h6>
                        <a href="contact-us-classic-02.html" class="btn btn-medium btn-rounded btn-deep-pink wow animate__fadeInUp" data-wow-delay="0.2s">Start New Projects</a>
                    </div>
                </div>
            </div>
        </section>
                        ...
                        <div class="col-lg-4 col-md-5 text-center">
                            ...
                            <div class="social-icon-style-8 d-inline-block align-middle">
                                <ul class="small-icon mb-0">
                                    ...
                                    <li><a class="twitter text-white-2" href="https://twitter.com/" target="_blank"><i class="fa-brands fa-twitter"></i></a></li>
                                    <li><a class="google text-white-2" href="https://plus.google.com" target="_blank"><i class="fa-brands fa-google-plus-g"></i></a></li>
                                    <li><a class="instagram text-white-2" href="https://instagram.com/" target="_blank"><i class="fa-brands fa-instagram no-margin-right" aria-hidden="true"></i></a></li>
                                </ul>
                            </div>
                        </div>
                        <!-- end social media -->
