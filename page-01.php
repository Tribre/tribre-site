...
<html class="no-js" lang="en">
    ...
    <body>
        ...
        <section>
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-5 offset-lg-1 line-height-28 last-paragraph-no-margin md-margin-50px-bottom sm-margin-30px-bottom wow animate__fadeIn">
                        <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages.</p>
                    </div>
                    <div class="col-lg-4 offset-lg-1 line-height-26 wow animate__fadeIn">
        ...
        <section class="wow animate__fadeIn pb-0">
            <div class="container">
                <div class="row margin-eight-bottom md-margin-50px-bottom sm-margin-20px-bottom">
                    <div class="col-lg-6 last-paragraph-no-margin md-margin-30px-bottom wow animate__fadeInUp">
                    ...
                    <div class="col-xl-5 col-lg-6 offset-xl-1 wow animate__fadeInUp"  data-wow-delay="0.2s">
            ...
            <div class="container-fluid p-0">
                <div class="row g-0">
                    <div class="col-12 filter-content overflow-hidden">
                        <ul class="hover-option4 lightbox-gallery portfolio-wrapper grid grid-loading grid-4col xl-grid-4col lg-grid-4col md-grid-2col sm-grid-2col xs-grid-1col">
        ...
        <section class="wow animate__fadeIn">
            <div class="container">
                <div class="row">
                    <div class="col-xl-6 col-lg-8 mx-auto margin-eight-bottom text-center">
